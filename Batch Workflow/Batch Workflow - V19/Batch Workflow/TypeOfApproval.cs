...
{
    class TypeOfApproval
    {
        public void typeofapproval_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from dbo.vw_batchworkflow_typeofapproval_dotnet order by TypeOfApproval";
