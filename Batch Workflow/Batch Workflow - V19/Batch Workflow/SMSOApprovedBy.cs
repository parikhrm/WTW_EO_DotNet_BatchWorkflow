...
{
    class SMSOApprovedBy
    {
        public void smsoapprovedby_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from dbo.tbl_batchworkflow_smso_approver_list_dotnet with(nolock) where IsDeleted = 0 order by EmailAddress";
