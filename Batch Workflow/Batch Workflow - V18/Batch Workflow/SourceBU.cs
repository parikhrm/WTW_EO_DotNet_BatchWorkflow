...
namespace Batch_Workflow
{
    class SourceBU
    {
        public void sourcebu_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select distinct ReportingID from dbo.vw_batchworkflow_rdcupload_archive_dotnet where ReportingID is not null and ReportingID <> '' order by ReportingID asc";
        ...
        public void sourcebu_searchby_list(DataTable dta)
        {
            string connectionstringtxt = "Data Source=A20-CB-DBSE01P;Initial Catalog=DRD;User ID=DRDUsers;Password=24252425";
            //string connectionstringtxt = System.Configuration.ConfigurationManager.ConnectionStrings["connection_string"].ConnectionString;
            SqlCommand cmd = new SqlCommand();
