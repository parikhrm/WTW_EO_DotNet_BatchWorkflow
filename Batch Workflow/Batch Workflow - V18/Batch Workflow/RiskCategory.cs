...
namespace Batch_Workflow
{
    class RiskCategory
    {
        public void riskcategory_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from dbo.vw_kycrdcworkflow_riskcategory_dotnet where id in (3,7,8,9,10) order by RiskCategory";
